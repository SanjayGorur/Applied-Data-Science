...
if __name__ == "__main__":
    ...
    ds.addSample(loadImage('pic/other1.png'),(2,))
    ds.addSample(loadImage('pic/other2.png'),(2,))
    ds.addSample(loadImage('pic/other3.png'),(2,))
    ds.addSample(loadImage('pic/other4.png'),(2,))
    ds.addSample(loadImage('pic/other5.png'),(2,))
    ds.addSample(loadImage('pic/other6.png'),(2,))
    ds.addSample(loadImage('pic/other7.png'),(2,))
    ds.addSample(loadImage('pic/other8.png'),(2,))
    ...
    print "\nResult: ", net.activate(loadImage('pic/other9.png'))
    print "\nResult: ", net.activate(loadImage('pic/other10.png'))
