...
#linear
#predicted_linear = results_linear.params * var
...
#logit
#predicted_logit = results_logit.params * var
y_hat_logit = results_logit.predict(X_pred)
union_count_logit = 0
for people in y_hat_logit:
  if float(people) > 0.2: union_count_logit += 1
print 'LOGIT : Estimated number of people which is Union : %d' % union_count_logit
...
print 'LOGIT : Estimated number of people which is Union : %d' % union_count_logit_act
...
print 'REAL DATA : Actual number of people which is Union : %d' % union_count_real